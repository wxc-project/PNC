========================================================================
    MICROSOFT 基础类库 : PartsEditorCore 项目概况
========================================================================


应用程序向导已为您创建了此 PartsEditorCore DLL。此 DLL 不仅
说明了使用 Microsoft 基础类的基础，而且
也是编写 DLL 的起点。

此文件包含组成 PartsEditorCore DLL
的每个文件的内容摘要。

PartsEditorCore.vcproj
...
PartsEditorCore.h
    这是 DLL 的主头文件。它声明了
    CPartsEditorCoreApp 类。

PartsEditorCore.cpp
    这是主 DLL 源文件。它包含了类 CPartsEditorCoreApp。
PartsEditorCore.rc
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 PartsEditorCore.pch
